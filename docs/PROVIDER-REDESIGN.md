...
| codex | Read-only, completed turn, exact resume | Commentary/final/retry/failure/JSONL EOF/output-file conflict fixtures | Two-turn acceptance-codex; reads work, writes denied, exact thread | Planned |
