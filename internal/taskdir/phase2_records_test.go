...
func phase2Task(t *testing.T, s *Store) *TaskDir {
	t.Helper()
...
func phase2Submit(t *testing.T, td *TaskDir) *task.SubmitRecord {
	t.Helper()
...
func phase2Receipt(t *testing.T, td *TaskDir) task.SupervisorReceipt {
	t.Helper()
