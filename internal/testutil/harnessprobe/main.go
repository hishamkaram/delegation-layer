// Command harnessprobe exercises the actual configuration boundary without any
...
func inspect(args []string) (report, error) {
	if len(args) != 2 && len(args) != 3 {
		return report{}, errors.New("usage: harnessprobe parse CONFIG | isolate CONFIG BASE")
	}
