...
func (r SupervisorReceipt) SupervisorRef() SupervisorRef {
	return SupervisorRef{ConfigPath: r.ConfigPath, Endpoint: r.Endpoint, ConfigDigest: r.ConfigDigest, ObservedVersion: r.ObservedVersion, ClientExecutable: r.ClientExecutable, ClientSHA256: r.ClientSHA256, ResolvedConfigSHA256: r.ResolvedConfigSHA256}
}
